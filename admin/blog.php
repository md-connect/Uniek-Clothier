...
if (isset($_POST['upload'])) {
  ...
  if ($input_err == "") {
    $insert = mysqli_query($conn, "INSERT INTO blog(title, body, picture, timedate) 
                VALUES('$title', '$body','$picture', '$date')");
    if ($insert) {
...
<head>
  ...
  <title>Uniek - Add Blog Post</title>
        ...
        <nav class="navbar navbar-expand-lg navbar-light">
          ...
          <div class="collapse navbar-collapse" id="navbarNav">
            <ul class="navbar-nav flex-column">
              ...
              <li class="nav-item ">
                <a class="nav-link active" href="blog.php"><i class="fa fa-fw fa-users"></i>Add Blog Post</a>
              </li>
              <li class="nav-item ">
        ...
        <div class="row">
          <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
            <div class="page-header">
              <h2 class="pageheader-title">Add Blog Post</h2>
              <p class="pageheader-text">
                Adding Blog Post to the database
              </p>
              <div class="page-breadcrumb">
                <nav aria-label="breadcrumb">
                  <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item">
                      <a href="#" class="breadcrumb-link">Add Blog Post</a>
                    </li>
                  </ol>
                </nav>
              </div>
                ...
                <div class="card">
                    ...
                    <form method="POST" action="#" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control" id="exampleFormControlTextarea1" name="body" rows="4"></textarea>
                            <?php echo "<div class='red'> $input_err</div>" ?>
                        </div>
                        ...
                        <hr>
                        <button type="submit" name="upload" class="btn btn-primary btn-block">Upload Blog Post</button>
                    </form>
                </div>
            </div>
        </div>  
