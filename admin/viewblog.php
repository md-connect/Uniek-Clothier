...
if (isset($_POST['delete_blog'])) {
    $post_id = test_input($_POST['delete_blog']);
    $slq_delete = mysqli_query($conn, "DELETE FROM blog WHERE sn='$post_id'");
    if ($slq_delete) {
                ...
                <div class="row">
                    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                        <div class="page-header">
                            <h2 class="pageheader-title">All Blog posts </h2>
                            <p class="pageheader-text">List of blog posts currently in the database.</p>
                            <div class="page-breadcrumb">
                                <nav aria-label="breadcrumb">
                                    <ol class="breadcrumb">
                                        <li class="breadcrumb-item"><a href="index.php" class="breadcrumb-link">Dashboard</a></li>
                                        <li class="breadcrumb-item"><a href="#" class="breadcrumb-link">All Blog Posts</a></li>
                                    </ol>
                                </nav>
                            </div>
                        </div>
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                <table id="example" class="display" style="width:100%">
                                    ...
                                    <tbody>
                                        <?php
                                        $sql = mysqli_query($conn, "SELECT * FROM blog ORDER BY timedate DESC");
                                        if (mysqli_num_rows($sql) > 0) {
                                            ...
                                            while ($row = mysqli_fetch_assoc($sql)) {
                                                echo '<tr>
                                                        ...
                                                        <td>' . $row['timedate'] . '</td>
                                                        <td>
                                                            <form action="edit-blog.php" method="POST" class="col s12">
                                                                <div>
                                                                    <input hidden name="blog_id" type="text" class="validate" value=" ' . $row['sn'] . '">
                                                                    <button class="btn-flat" type="submit" name="edit_blog" class="white">
                                                        ...
                                                        <td>
                                                            <form action="" method="POST" class="col s12">
                                                                <div>
                                                                    <input hidden name="delete_blog" type="text" class="validate" value=" ' . $row['sn'] . '">
                                                                    <button class="btn-flat" type="submit" name="delete_blog" class="white">
