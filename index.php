...
<body class="animsition">
	...
	<header>
		...
		<div class="container-menu-desktop">
			...
			<div class="top-bar">
				<div class="content-topbar flex-sb-m h-full container">
					<div class="left-top-bar">
						Shipping for standard order around Lagos Axis
					</div>
			...
			<div class="wrap-menu-desktop">
				<nav class="limiter-menu-desktop container">
					...
					<!-- Logo desktop -->
					<a href="#" class="logo">
						<img src="images/icons/uniek.png" alt="IMG-LOGO">
					</a>
		...
		<div class="menu-mobile">
			<ul class="topbar-mobile">
				<li>
					<div class="left-top-bar">
						Shipping for standard order in Lagos
					</div>
	...
	<section class="section-slide">
		<div class="wrap-slick1">
			<div class="slick1">
				<div class="item-slick1" style="background-image: url(images/uniekslide.jpg);">
				...
				<div class="item-slick1" style="background-image: url(images/uniekslide2.jpg);">
					<div class="container h-full">
						<div class="flex-col-l-m h-full p-t-100 p-b-30 respon5">
				...
				<div class="item-slick1" style="background-image: url(images/uniekslide3.jpg);">
					<div class="container h-full">
						<div class="flex-col-l-m h-full p-t-100 p-b-30 respon5">
							<div class="layer-slick1 animated visible-false" data-appear="rollIn" data-delay="0">
								<span class="ltext-101 cl2 respon2">
				...
				<div class="item-slick1" style="background-image: url(images/uniekslide4.jpg);">
					<div class="container h-full">
						<div class="flex-col-l-m h-full p-t-100 p-b-30 respon5">
							<div class="layer-slick1 animated visible-false" data-appear="rollIn" data-delay="0">
								<span class="ltext-101 cl2 respon2">
				...
				<div class="item-slick1" style="background-image: url(images/uniek2.jpg);">
					<div class="container h-full">
						<div class="flex-col-l-m h-full p-t-100 p-b-30 respon5">
							<div class="layer-slick1 animated visible-false" data-appear="rotateInDownLeft" data-delay="0">
								<span class="ltext-101 cl2 respon2">
									Women Suit Collection 2020
								</span>
							</div>
				...
				<div class="item-slick1" style="background-image: url(images/uniek1.jpg);">
					<div class="container h-full">
						<div class="flex-col-l-m h-full p-t-100 p-b-30 respon5">
							<div class="layer-slick1 animated visible-false" data-appear="rollIn" data-delay="0">
								<span class="ltext-101 cl2 respon2">
			...
			<div class="row">
				<div class="col-md-6 col-xl-4 p-b-30 m-lr-auto">
					...
					<div class="block1 wrap-pic-w">
						<img src="images/banner4.png" alt="IMG-BANNER">
				...
				<div class="col-md-6 col-xl-4 p-b-30 m-lr-auto">
					<!-- Block1 -->
					<div class="block1 wrap-pic-w">
						<img src="images/banner5.png" alt="IMG-BANNER">
				...
				<div class="col-md-6 col-xl-4 p-b-30 m-lr-auto">
					<!-- Block1 -->
					<div class="block1 wrap-pic-w">
						<img src="images/banner6.png" alt="IMG-BANNER">
								...
								<div class="block2-txt flex-w flex-t p-t-14">
									<div class="block2-txt-child1 flex-col-l ">
										<a href="product-detail.php?pid=<?php echo $row['pd_id']; ?>" class="stext-104 cl4 hov-cl1 trans-04 js-name-b2 p-b-6">
											<strong><b><?php echo $row['pd_name']; ?></b></strong>
										</a>

										<span class="stext-105 cl4">
											Size 6-12: N<?php echo $row['size6_12_price']; ?> 
										</span>
										<span class="stext-105 cl3">
											Size 14-16: N<?php echo $row['size14_16_price']; ?>
										</span>
									</div>
						...
						<div class="row">
							...
							<div id='modal_info_panel' class="col-md-6 col-lg-5 p-b-30">
								<div class="p-r-50 p-t-5 p-lr-0-lg">
									...
									<span id="m_price" class="mtext-106 cl2"></span><br>
									<span id="m_price2" class="mtext-106 cl2"></span>
										...
										<div class="p-t-33">
											...
											<div class="size-204 respon6-next">
												<div class="rs1-select2 bor8 bg0">
													<select class="js-select2" name="color">
														...
														<?php
														$pdt_id="";
														$pdt_id .= '<span id="m_pd_id" class="mtext-106 cl2"></span>';
														$sql = "SELECT color FROM product";
											...
											<div class="flex-w flex-r-m p-b-10">
												<div class="size-204 flex-w flex-m respon6-next">
													...
													<!-- Price  -->
													<input hidden class="mtext-104 cl3 txt-center num-product" type="number" name="price" value="">
													<!-- End of price -->
	...
	<script>
		...
		$('.js-show-modal1').click(function(e) {
			...
			$('#m_pd_id').html(cont[ind]['pd_id']);
			$('#m_title').html(cont[ind]['pd_name']);
			$('#m_price').html('Size 6-12: N' + cont[ind]['size6_12_price']);
			$('#m_price2').html('Size 14-16: N' + cont[ind]['size14_16_price']);
