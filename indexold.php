		...
		case "add":
			...
			if (!empty($_POST["quantity"])) {
				...
				while ($productByCode = mysqli_fetch_array($result)) {
					$itemArray = array($productByCode["pd_id"] => array('name' => $productByCode["pd_name"], 'code' => $productByCode["pd_id"], 'quantity' => $_POST["quantity"], 'price' => $productByCode["size6_12_price"], 'image' => $productByCode["picture"]));
	...
	<section class="section-slide">
		<div class="wrap-slick1">
			<div class="slick1">
				...
				<div class="item-slick1" style="background-image: url(images/uniek3.jpg);">
					<div class="container h-full">
						<div class="flex-col-l-m h-full p-t-100 p-b-30 respon5">
							<div class="layer-slick1 animated visible-false" data-appear="rollIn" data-delay="0">
								<span class="ltext-101 cl2 respon2">
