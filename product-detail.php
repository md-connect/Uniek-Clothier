...
<body class="animsition">
	...
	$type = $row['pd_type'];
	$size6_12_price = $row['size6_12_price'];
	$size14_16_price = $row['size14_16_price'];
				...
				<div class="col-md-6 col-lg-5 p-b-30">
					<div class="p-r-50 p-t-5 p-lr-0-lg">
						...
						<span class="mtext-106 cl2">
							Size 6-12: N<?php echo $size6_12_price; ?>
						</span><br>
						<span class="mtext-106 cl2">
							Size 14-16: N<?php echo $size14_16_price; ?>
						</span>
								...
								<div class="flex-w flex-r-m p-b-10">
											...
											<div class="size-204 respon6-next">
												<div class="rs1-select2 bor8 bg0">
													<select id="sizeInput" class="js-select2" name="time" onchange="myFunction()">
			...
			<div class="wrap-slick2">
				<div class="slick2">
					...
					while ($row = mysqli_fetch_array($query)) {
						...
						$category = $row['pd_category'];
						$type = $row['pd_type'];
						$price1 = $row['size6_12_price'];
						$price2 = $row['size14_16_price'];
						$picture = $row['picture'];
						if (empty($row['picture2'])) {
							$picture2 = $row['picture'];
						} else {
	...
	<script>
		...
		//price vs size script
		var element = document.getElementById("sizeInput");
